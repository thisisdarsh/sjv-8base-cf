 ...
 *    8base invoke-local afterCreateUserTrigger -p src/resolvers/afterCreateUserTrigger/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local afterCreateUserTrigger -m request
 *
 ...
 *    8base generate mock afterCreateUserTrigger -m [MOCK_FILE_NAME]
 */
